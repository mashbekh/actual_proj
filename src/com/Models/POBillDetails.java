...
public class POBillDetails {
	...
	public POBillDetails(Products product, String description, Long quantity, BigDecimal price, Tax tax,
			BigDecimal subTotal, BigDecimal taxTotal, ObjectId id) {
		super();
